                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item" href="{{route('dataatlet.show', $data->id)}}">
                                                Detail
                                            </a>
                                            <a class="dropdown-item" href="{{route('dataatlet.edit', $data->id)}}"> Edit
                                            </a>
                                            <form action="{{ route('dataatlet.destroy', $data->id) }}" class="pull-left"
                                                method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
