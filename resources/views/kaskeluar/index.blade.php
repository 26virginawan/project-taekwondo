...
<div class="row">
    ...
    <div class="col-lg-2">
        <a href="{{ route('kaskeluar.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i>
            Tambah Kas Keluar</a>
    </div>
    <div class="col-lg-12">
...
<div class="row" style="margin-top: 20px;">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body ">
                <h4 class="card-title">Jumlah Kas Keluar</h4>
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item" href="{{route('kaskeluar.show', $data->id)}}">
                                                Detail
                                            </a>
